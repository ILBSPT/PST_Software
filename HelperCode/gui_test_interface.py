...
layout_fill = [[sg.Button('LED_ON', key = '_LED_ON_', size = (10,5)), sg.Button('LED_OFF', key = '_LED_OFF_', size = (10,5)), sg.Text("Ax  Ay  Az  Gx  Gy  Gz", key = '_STATUS_OUT_', size = (40, 5), auto_size_text=True, font=('Arial Bold', 16))],      
          [sg.Button('Exec prog', key = '_EXEC_', size = (10, 5)),
